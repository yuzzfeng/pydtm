...
coords9n = [[-7.5, -7.5], [-7.5, 7.5], [-7.5, 22.5],
            [7.5, -7.5], [7.5, 7.5],[7.5, 22.5],
            [22.5, -7.5], [22.5, 7.5], [22.5, 22.5]]
coords = np.array(coords9n)
        
## Center of the neibouring 9 tiles
#coords25n = [ [-22.5, -22.5], [-22.5, -7.5], [-22.5, 7.5], [-22.5, 22.5], [-22.5, 37.5],
#              [-7.5, -22.5], [-7.5, -7.5], [-7.5, 7.5], [-7.5, 22.5], [-7.5, 37.5],
#              [7.5, -22.5], [7.5, -7.5], [7.5, 7.5], [7.5, 22.5], [7.5, 37.5],
#              [22.5, -22.5], [22.5, -7.5], [22.5, 7.5], [22.5, 22.5], [22.5, 37.5],
#              [37.5, -22.5], [37.5, -7.5], [37.5, 7.5], [37.5, 22.5], [37.5, 37.5]]
...
def reject_local_change(dict_shift_value, list_mms, thre = 0.3):
...
if 1:
    ...
    while count < 5 or num_changes > 10:
        dict_shift_value = reject_local_change(dict_shift_value, list_mms)
        height_needed = find_time_without_value(dict_shift_value, list_mms)    
