...
def ground_filter(data_mms, radius, res_list, r):
    ...
    for res in res_list:
        ...
        indexs_res, new_data = update_points(data_mms, d_mms1, img, threshold, res, radius)
##        indexs_res, new_data = update_by_gradient(data_mms, d_mms1, img, threshold, res, radius)
...
def update_points(data_mms, d_mms1, img, threshold, res, radius):
